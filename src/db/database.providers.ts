...
import { Appeal } from '../modules/admin/modules/appeal/models/appeal.entity';
import { AppealType } from '../modules/admin/modules/appeal-type/models/appeal-type.entity';
